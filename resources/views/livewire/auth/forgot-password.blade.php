    ...
    <div class="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-8">
        ...
        @if($emailSent)
            <div class="text-center py-8">
                <div class="mx-auto w-16 h-16 bg-primary/15 dark:bg-primary/20 rounded-full flex items-center justify-center mb-4">
                    <svg class="w-8 h-8 text-primary dark:text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a 
                    href="{{ route('login') }}" 
                    class="inline-block px-6 py-2.5 bg-primary hover:bg-primary/90 text-white font-medium rounded-lg transition-colors duration-200 cursor-pointer"
                >
                    Volver al Login
                </a>
            </div>
