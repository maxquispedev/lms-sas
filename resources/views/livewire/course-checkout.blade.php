...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="max-w-6xl mx-auto px-4 py-10 lg:py-14">
        ...
        {{-- Session messages --}}
        @if(session('error'))
            <div class="mb-6 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 text-red-800 dark:text-red-200 px-5 py-4 rounded-xl shadow-sm">
        ...
        @if(session('message'))
            <div class="mb-6 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 text-green-800 dark:text-green-200 px-5 py-4 rounded-xl shadow-sm">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div class="lg:col-span-7 space-y-6">
                ...
                {{-- Course image --}}
                <div class="relative rounded-2xl overflow-hidden shadow-xl aspect-video bg-gray-200 dark:bg-gray-700">
                    @if($course->image_url)
                        <img
                ...
                <div>
                    ...
                    <div class="flex items-baseline gap-3 mt-3 flex-wrap">
                        ...
                        @endif
                        <span class="text-sm text-gray-400 dark:text-gray-500">PEN · Pago único</span>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
                    ...
                    <ul class="space-y-3">
                        @php
                            $benefits = [
                                ['icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'text' => $course->access_text],
                                ['icon' => 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z', 'text' => 'Certificado de finalización'],
                                ['icon' => 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z', 'text' => 'Acceso a todas las lecciones y videos'],
                                ['icon' => 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4', 'text' => 'Materiales y recursos descargables'],
                                ['icon' => 'M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z', 'text' => 'Soporte y actualizaciones incluidas'],
                            ];
                        @endphp
                        @foreach($benefits as $benefit)
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">{{ $benefit['text'] }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                {{-- Guarantee --}}
                <div class="flex items-start gap-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800/40 rounded-2xl p-5">
                    <div class="flex-shrink-0 w-12 h-12 bg-amber-100 dark:bg-amber-800/40 rounded-full flex items-center justify-center">
                        <svg class="w-6 h-6 text-amber-600 dark:text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                    </div>
                    <div>
                        <p class="font-bold text-amber-800 dark:text-amber-300 text-sm">Compra protegida</p>
                        <p class="text-amber-700 dark:text-amber-400 text-xs mt-1 leading-relaxed">Tu pago está protegido con encriptación de 256 bits. Tus datos financieros nunca son almacenados en nuestros servidores.</p>
                    </div>
                </div>
                ...
                <div class="sticky top-6">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div class="flex items-start gap-3 pb-4 border-b border-gray-100 dark:border-gray-700">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-semibold text-gray-800 dark:text-gray-200 leading-tight line-clamp-2">{{ $course->title }}</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Acceso de por vida</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                @if($course->hasSalePrice())
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-500 dark:text-gray-400">Precio regular</span>
                                        <span class="text-gray-400 line-through">S/ {{ number_format((float) $course->price, 2, '.', ',') }}</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-green-600 dark:text-green-400 font-medium">Descuento especial</span>
                            ...
                            @guest
                                <div class="pt-2 space-y-4 border-t border-gray-100 dark:border-gray-700">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wide">Crea tu cuenta para acceder al curso</p>

                                    <div class="grid grid-cols-2 gap-3">
                                        <div>
                                            <label for="first_name" class="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1.5">
                                                Nombre
                                            </label>
                                            <input
                                                type="text"
                                                ...
                                                class="w-full px-3 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary/30 focus:border-primary bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 transition"
                                        ...
                                        <div>
                                            <label for="last_name" class="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1.5">
                                                Apellido
                                            </label>
                                            <input
                                                type="text"
                                    ...
                                    <div>
                                        <label for="password" class="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1.5">
                            ...
                            <div class="flex items-center justify-center gap-3 pt-1">
                                ...
                                <span class="text-gray-200 dark:text-gray-700">|</span>
                                <span class="text-xs text-gray-400 dark:text-gray-500 font-medium">Culqi</span>
                            </div>
                    ...
                    <div class="mt-4 grid grid-cols-3 gap-3 text-center">
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-3 border border-gray-100 dark:border-gray-700">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 font-medium leading-tight">Acceso<br>inmediato</p>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-3 border border-gray-100 dark:border-gray-700">
                            <svg class="w-5 h-5 text-primary mx-auto mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                            </svg>
                            <p class="text-xs text-gray-500 dark:text-gray-400 font-medium leading-tight">Desde cualquier<br>dispositivo</p>
                        </div>
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-3 border border-gray-100 dark:border-gray-700">
                            <svg class="w-5 h-5 text-primary mx-auto mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" />
                            </svg>
                            <p class="text-xs text-gray-500 dark:text-gray-400 font-medium leading-tight">Soporte<br>incluido</p>
                        </div>
                    </div>
